...
public sealed class PaymentSucceededHandler
{
    ...
    private const string ServiceName = "kitchen";
    ...
    public Task<HandleResult> HandleAsync(byte[] body, IBasicProperties? props, CancellationToken ct)
    {
        ...
        var attemptNumber = ConsumerRetry.ReadAttemptNumber(props);
        return HandleAsync(evt, attemptNumber, ct);
    }

    public async Task<HandleResult> HandleAsync(PaymentSucceededEvent evt, int attemptNumber, CancellationToken ct)
    {
