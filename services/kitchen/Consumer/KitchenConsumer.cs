...
public sealed class KitchenConsumer : BackgroundService
{
    private readonly RabbitMqOptions _broker;
    private readonly KitchenConsumerOptions _consumer;
    ...
    public KitchenConsumer(
        ...
        IOptions<KitchenConsumerOptions> consumer,
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        _logger.LogInformation(
            "KitchenConsumer started on queue '{Queue}' (routingKey '{RoutingKey}', prefetch={Prefetch})",
